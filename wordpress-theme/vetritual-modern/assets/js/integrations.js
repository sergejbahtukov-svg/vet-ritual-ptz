(function () {
  ...
  var rawConfig = window.vrAnalyticsConfig || {};
  ...
  var scriptDataset = currentScript && currentScript.dataset ? currentScript.dataset : {};
  ...
  var datasetConfig = {
    mode: scriptDataset.mode || 'disabled',
    cookieKey: scriptDataset.cookieKey || 'vr_cookie_consent',
    ymId: scriptDataset.ymId || '',
    ymWebvisor: toBoolean(scriptDataset.ymWebvisor, false),
    ymEcommerce: toBoolean(scriptDataset.ymEcommerce, false),
    ga4Id: scriptDataset.ga4Id || '',
    gtmId: scriptDataset.gtmId || '',
    vkId: scriptDataset.vkId || '',
    metaId: scriptDataset.metaId || '',
    topmailruId: scriptDataset.topmailruId || '',
    tiktokId: scriptDataset.tiktokId || '',
  };

  var config = {
    mode: rawConfig.mode || datasetConfig.mode || 'disabled',
    cookieKey: rawConfig.cookieKey || datasetConfig.cookieKey,
    ymId: rawConfig.ymId || datasetConfig.ymId,
    ymWebvisor: toBoolean(rawConfig.ymWebvisor, datasetConfig.ymWebvisor),
    ymEcommerce: toBoolean(rawConfig.ymEcommerce, datasetConfig.ymEcommerce),
    ga4Id: rawConfig.ga4Id || datasetConfig.ga4Id,
    gtmId: rawConfig.gtmId || datasetConfig.gtmId,
    vkId: rawConfig.vkId || datasetConfig.vkId,
    metaId: rawConfig.metaId || datasetConfig.metaId,
    topmailruId: rawConfig.topmailruId || datasetConfig.topmailruId,
    tiktokId: rawConfig.tiktokId || datasetConfig.tiktokId
  };

  if (config.mode === 'on_consent') {
    config.mode = 'after_cookie_accept';
  }
