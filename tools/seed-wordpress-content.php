...
$price_groups = array(
    ...
    'obschaya-krematsiya' => array(
        ...
        'rows' => array(
            array('label' => 'до 1 кг', 'value' => '1 500 руб.'),
            array('label' => '1-5 кг', 'value' => '2 000 руб.'),
            array('label' => '5-10 кг', 'value' => '2 500 руб.'),
            array('label' => '10-20 кг', 'value' => '3 000 руб.'),
            array('label' => '20-30 кг', 'value' => '4 000 руб.'),
            array('label' => '30-40 кг', 'value' => '5 000 руб.'),
            array('label' => '40-50 кг', 'value' => '7 500 руб.'),
        ),
    ),
    'individualnaya-krematsiya' => array(
        ...
        'rows' => array(
            array('label' => 'до 1 кг', 'value' => '4 500 руб.'),
            array('label' => '1-5 кг', 'value' => '7 500 руб.'),
            array('label' => '5-10 кг', 'value' => '8 000 руб.'),
            array('label' => '10-20 кг', 'value' => '8 500 руб.'),
            array('label' => '20-30 кг', 'value' => '9 500 руб.'),
            array('label' => '30-40 кг', 'value' => '11 500 руб.'),
            array('label' => '40-50 кг', 'value' => '13 500 руб.'),
            array('label' => 'более 50 кг', 'value' => 'от 16 000 руб.'),
        ),
    ),
);
